...
var token = '1422206358:AAFkTNhkkyc4OoBVyjFL_yGsBDI7MKFf6kk' //                  
...
bot.onText(/^\/L|D\s*([0-9]+)*&([a-zA-Z0-9#?!@$%^&*-]+)$/, (msg, match) => {
    if (msg.from.is_bot) {
        return;
    }
...
bot.onText(/^\/help|start$/, (msg, match) => {
    ...
    var txt = "Có 100$ hãy vào bot này nha, không thua ráng chịu mà có 10000$ thì vẫn thua như thường hahahaaa\n\
...
function getCandle(id) {
	botSendMessage(msg.chat.id, "get candle đó nha", { parse_mode: 'HTML' });
